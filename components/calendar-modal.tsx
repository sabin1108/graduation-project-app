...
export default function CalendarModal({ open, onOpenChange }: CalendarModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-hidden bg-gradient-to-br from-slate-50 to-white border-0 shadow-2xl">
        ...
        <div className="flex gap-6 p-5 h-[calc(90vh-100px)]">
          {/* Calendar Section */}
                  ...
                  {weeks.flat().map((day, index) => {
                    return (
                      <button
                        ...
                        className={cn(
                          "h-32 border-r border-b border-gray-100 transition-all duration-200 hover:bg-gray-50 relative group overflow-hidden w-full",
          ...
          <div className="w-80 bg-white rounded-xl shadow-lg border border-gray-100 p-5 overflow-hidden flex flex-col">
            <div className="mb-5">
